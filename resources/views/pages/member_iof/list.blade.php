            ...
            <div class="row justify-content-between">
                <div class="col-12 col-md-auto ">
                    <div class="row  q-col-gutter-sm q-px-sm">
                        <div class="col">
                            <div class="h5 font-weight-bold text-primary">ANGGOTA IOF PENGCAB BEKASI RAYA</div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class=" page-content">
                        <div id="member_iof-list-records">
                            <?php
                                if($total_records){
                            ?>
                            <div id="page-main-content">
                                ...
                                <?php Html::page_bread_crumb("member_iof/", $field_name, $field_value); ?>
                                <div class="row gutter-lg page-data">
                                    ...
                                    <div class="col-sm-4 col-md-3">
                                        <div class="h4 text-primary bg-dark mb-3 card-4">
                                            <div class="row gutter-sm justify-content-between">
                                                <div class="col-3">
                                                    <a href="<?php print_link("member_iof/view/$rec_id"); ?>" class="d-block card-link ">
                                                    <img style="height: 60px; width: 100px" src="{{ getImgSizePath($data['photo'], 'medium') }}" class="img-fluid" />
                                                </a>
                                            </div>
                                            <div class="col-7">
                                            ...
                                            <small class="text-muted"><?php echo ($data['club_nama']); ?></small>
                                        </div>
                                        <div class="col-2">
