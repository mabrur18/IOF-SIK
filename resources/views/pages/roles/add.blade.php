                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-guard_name-holder" class=" ">
                                                <input id="ctrl-guard_name"  value="<?php echo get_value('guard_name') ?>" type="text" placeholder="Enter Guard Name" list="guard_name_list"  name="guard_name"  class="form-control " />
                                                ...
                                                <?php
                                                    ...
                                                    $value = $option['value'];
                                                    $label = $option['label'];
                                                    $selected = Html::get_field_selected('guard_name', $value);
                                                ?>
                                                <option <?php echo $selected ?> value="<?php echo $value ?>">
                                                <?php echo $label ?>
                                                </option>
