            ...
            <div class="row justify-content-between">
                <div class="col-12 col-md-auto ">
                    <div class="row  q-col-gutter-sm q-px-sm">
                        <div class="col">
                            <div class="h5 font-weight-bold text-primary">LIST CLUB IOF PENGCAB BEKASI RAYA</div>
                    ...
                    <div  class=" page-content">
                        <div id="club_iof-list-records">
                            ...
                            <div id="page-main-content">
                                ...
                                <?php Html::page_bread_crumb("club_iof/", $field_name, $field_value); ?>
                                <div class="row gutter-lg page-data">
                                    ...
                                    <div class="col-sm-4 col-md-3">
                                        <div class="card-4 mb-3">
                                            <a href="<?php print_link("club_iof/view/$rec_id"); ?>" class="d-block card-link ">
                                            <h6 class="font-weight-bold h4 text-dark bg-light pb-2"><?php echo ($data['club_nama']); ?></h6>
                                            <img src="{{ getImgSizePath($data['logo_club'], 'small') }}" class="img-fluid" />
                                        </a>
                                        <div class="pt-2"><?php echo ($data['alamat_club']); ?></div>
                                        <hr class="my-2" />
                                        <div class="d-flex justify-content-between">
                                            <small class="text-muted"><?php echo ($data['no_reg_club']); ?></small>
                                            <div class="d-flex justify-content-between">
                                                <div class="dropdown" >
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <?php if($can_view){ ?>
                                                        <a class="dropdown-item "   href="<?php print_link("club_iof/view/$rec_id"); ?>">
